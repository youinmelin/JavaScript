...
<div>
    ...
    有种船从来没下过水，为什么还是船？
        ...
        <br><span id="answer"> 答案：宇宙飞船</span>

    <script type="text/javascript">$("#answer").hide();</script>

   <input type="button" id="show_btn"  class="btn btn-sm" value="显示答案">
   <input type="button" id="hide_btn"  class="btn btn-sm" value="隐藏答案">    <script type="text/javascript">    $("#hide_btn").hide();  </script>
